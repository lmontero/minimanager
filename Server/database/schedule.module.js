...
function execute(schedules, lastScheduleId, roomModule, teamModule) {
  
  
  
  
  function insertOne(schedule) {
    if (!schedules) {
    ...
    return Promise.resolve()
      ...
      .then(function () {
        var resultSchedule = schedules.filter(function (innerSchedule) {
          ...
          return innerSchedule.RoomId == schedule.RoomId && !compareIfADateTimeIsLessOrEqualThanAnotherDateTime(innerSchedule.EndingDateTime, '' + currentDateTime) &&
